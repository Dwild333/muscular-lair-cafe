...
(function () {
  const TH = {
    ...
    "Login password": "รหัสผ่านเข้าระบบ",
    "Change the shared password everyone uses to open the app. Staff stay signed in; the new password is needed next time they log in.": "เปลี่ยนรหัสผ่านที่ใช้ร่วมกันเพื่อเปิดแอป พนักงานยังคงเข้าระบบอยู่ และจะใช้รหัสใหม่ในการเข้าครั้งถัดไป",
    "New password": "รหัสผ่านใหม่", "Confirm new password": "ยืนยันรหัสผ่านใหม่",
    "Update password": "อัปเดตรหัสผ่าน", "Saving…": "กำลังบันทึก…", "Login password updated": "อัปเดตรหัสผ่านแล้ว",
    "Use at least 8 characters.": "ใช้อย่างน้อย 8 ตัวอักษร", "The two passwords don't match.": "รหัสผ่านสองช่องไม่ตรงกัน",
    "Could not update password.": "อัปเดตรหัสผ่านไม่สำเร็จ",
